...
/**
 * footer.js
 * Este archivo renderiza dinámicamente el pie de página común para todas las vistas.
 */

// 1. Define la función reutilizable renderFooter
function renderFooter() {
    // 2. Accede al Contenedor del Pie de Página mediante su ID
    const footer = document.getElementById("footer");

    // Verificación de seguridad: solo procede si el elemento existe en el HTML actual
    if (!footer) return;

    // 3. Inyecta el Contenido HTML usando una cadena de plantilla
    footer.innerHTML = `
        <footer class="footer">
            <div class="footer-container">
...
// 4. Llama a la Función al final del archivo para que se ejecute al cargar el script
renderFooter();